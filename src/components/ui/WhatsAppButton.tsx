...
export const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center group"
