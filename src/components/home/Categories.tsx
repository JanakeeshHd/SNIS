          ...
          {SITE_CONTENT.products.categories.map((category, i) => (
            ...
            >
              ...
              <div className="flex-1 p-10 md:p-12 flex flex-col justify-center">
                <div className="mb-6 w-14 h-14 rounded-2xl bg-white shadow-soft flex items-center justify-center text-secondary group-hover:bg-secondary group-hover:text-white transition-all duration-500">
