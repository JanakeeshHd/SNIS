      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="p-10 bg-slate-50 rounded-[3rem] border border-slate-100 shadow-soft">
              <h2 className="text-3xl font-black text-slate-900 mb-6">Market Reputation</h2>
              <div className="flex items-center space-x-4 mb-8">
                <div className="text-6xl font-black text-industrial-blue">4.8</div>
                <div>
                ...
                {[
                  ...
                  <div key={stat.label}>
                    <div className="flex justify-between text-xs font-black uppercase tracking-wider mb-2">
                      ...
                      <span className="text-industrial-blue">{stat.value}%</span>
                    </div>
          ...
          <div className="lg:col-span-8 space-y-12">
            <div>
              <div className="text-industrial-orange font-bold uppercase tracking-widest text-xs mb-4">Client Testimonials</div>
              <h3 className="text-4xl font-black text-slate-900 mb-10 tracking-tight">Voices of Industrial Excellence</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {reviews.map((review, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="p-8 bg-white rounded-3xl border border-slate-100 shadow-premium hover:border-tech-cyan transition-colors"
                >
                  <div className="flex text-industrial-orange mb-6">
                    {[...Array(5)].map((_, i) => <Star key={i} className="w-4 h-4 fill-current" />)}
                  </div>
                  <p className="text-slate-600 font-medium leading-relaxed mb-8 italic">"{review.text}"</p>
                  <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                    <div>
                      <div className="text-sm font-black text-slate-900">{review.name}</div>
              ...
              <div className="p-8 bg-industrial-blue rounded-3xl flex flex-col justify-center items-center text-center text-white relative overflow-hidden group cursor-pointer">
                 <div className="relative z-10">
                    <MessageSquare className="w-12 h-12 mb-4 mx-auto text-tech-cyan" />
                 ...
                 <div className="absolute inset-0 bg-tech-cyan opacity-0 group-hover:opacity-10 transition-opacity" />
              </div>
            </div>
          </div>
        </div>
