    ...
    <section className="py-32 bg-[#DAF7DC]">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div>
              <div className="text-[#336699] font-bold uppercase tracking-widest text-xs mb-4 text-center lg:text-left">Corporate Overview</div>
              <h2 className="text-4xl md:text-5xl font-black text-[#2F4858] mb-8 text-center lg:text-left">Leading the Industrial Automation Ecosystem</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {stats.map((stat, i) => (
                <div key={i} className="flex items-center space-x-4 p-5 bg-white rounded-2xl shadow-soft border border-slate-100 transition-transform hover:-translate-y-1">
                  <div className="w-10 h-10 rounded-xl bg-[#2F4858]/5 flex items-center justify-center text-[#2F4858] shrink-0">
                    {stat.icon}
                  </div>
                  <div>
                    <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{stat.label}</div>
                    <div className="text-sm font-black text-[#2F4858]">{stat.value}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <motion.div
            ...
            className="relative"
          >
             <div className="bg-[#2F4858] rounded-[3rem] p-12 text-white shadow-corporate relative overflow-hidden">
                   ...
                   <div className="space-y-6">
                      {[
                        ...
                        <div key={i} className="flex items-start space-x-4 group">
                          <div className="mt-1 flex-shrink-0 w-6 h-6 rounded-full bg-[#9EE493]/20 flex items-center justify-center group-hover:bg-[#9EE493] transition-colors">
                            <CheckCircle2 className="w-4 h-4 text-[#9EE493] group-hover:text-[#2F4858]" />
                          </div>
                          <span className="text-lg font-medium text-[#DAF7DC] group-hover:text-white transition-colors">{item}</span>
                        </div>
                      ))}
                   </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#9EE493]/10 rounded-full -ml-24 -mb-24 blur-3xl" />
             </div>
          </motion.div>
        </div>
      </div>
