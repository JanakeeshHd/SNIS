      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <div className="text-tech-cyan font-bold uppercase tracking-widest text-xs mb-4">Market Leading Solutions</div>
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">Featured Technical Products</h2>
            ...
            {categories.map(cat => (
              <button
                ...
                className={cn(
                  ...
                  activeFilter === cat 
                    ? "bg-white text-industrial-blue shadow-soft" 
            ...
            {filteredProducts.map((product, i) => (
              ...
              >
                <div className="relative aspect-square rounded-[1.7rem] bg-slate-100 overflow-hidden mb-6">
                  <div className="absolute inset-0 bg-gradient-to-br from-industrial-blue/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <div className="absolute top-4 left-4 flex flex-col gap-2">
                    <span className="px-3 py-1 bg-white/90 backdrop-blur-sm text-[10px] font-black text-industrial-blue rounded-full shadow-soft uppercase tracking-wider">
                      {product.category}
                    </span>
                    {i < 3 && (
                      <span className="px-3 py-1 bg-industrial-orange text-white text-[10px] font-black rounded-full shadow-soft uppercase tracking-wider">
                        Best Seller
                      </span>
                    )}
                  </div>
                  ...
                  <div className="w-full h-full flex items-center justify-center text-slate-300 group-hover:scale-110 transition-transform duration-700">
                    ...
                    <div className="relative">
                       ...
                       <div className="absolute top-0 left-0 w-24 h-24 border-2 border-tech-cyan/20 rounded-lg transform -rotate-12 group-hover:rotate-0 transition-transform" />
                    </div>
                  </div>

                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
                    <Button className="bg-white text-industrial-blue hover:bg-industrial-blue hover:text-white rounded-xl shadow-premium font-bold px-6">
                      View Details
                    </Button>
                  </div>
                </div>
                ...
                <div className="px-5 pb-6 flex-grow flex flex-col">
                  <h3 className="text-xl font-black text-slate-900 mb-2 line-clamp-2 group-hover:text-industrial-blue transition-colors">
                    {product.name}
                  </h3>
                  ...
                  <div className="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
                    ...
                    <button className="flex items-center space-x-2 text-industrial-orange font-black text-sm group/btn">
                      <span>Get Quote</span>
